...
gulp.task('rev',function(){
    return gulp.src(['dist/js/page/*.json','./src/*.html'])
    .pipe( revCollector({
        replaceReved: true
    }))
...
gulp.task('html', function () {
    gulp.src('dist/js/page/*.html')
    //.pipe(useref())
    //.pipe(rev())
    //.pipe(revReplace())
    .pipe(gulp.dest('dist/'));

//	gulp.src(['src/js/page/*.json','src/js/page/*.js'])
//  .pipe(gulp.dest('dist/js/page/'));
...
gulp.task('default',['copy:html','copy:jslib','copy:config','devjs']);


//部署
//gulp.task('build',['minifyhtml','copy:jslib','copy:config','minifycss','minifyjs'],'rev','html');
gulp.task('build',function(){
	// 设置队列
  	runSequence('clean',['copy:jslib','copy:config','minifycss','minifyjs','minifyhtml'],'rev','html',);
});
